...
public class CountDuplicatesInMergeTest {
    ...
    public void integerTest() {
        ...
        ArrayUtility<Integer> arrayUtility = new ArrayUtility<Integer>(inputArray, valueToEvaluate);
    ...
    public void longTest() {
        ...
        ArrayUtility<Long> arrayUtility = new ArrayUtility<Long>(inputArray, valueToEvaluate);
    ...
    public void stringTest() {
        ...
        ArrayUtility<String> arrayUtility = new ArrayUtility<String>(inputArray, valueToEvaluate);
    ...
    public void objectTest() {
        ...
        ArrayUtility<Object> arrayUtility = new ArrayUtility<Object>(inputArray, valueToEvaluate);
